...
class GPSA(nn.Module):
    ...
    def get_rel_indices(self, num_patches):
        ...
        rel_indices = torch.zeros(1, num_patches, num_patches, 3)  # [1, 64, 64, 3]
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=48, depth=12,
        ...
        if self.use_pos_embed:
            ...
            # add to sinusoid 2d
            # self.pos_embed = positionalencoding2d(embed_dim, int(num_patches**.5), int(num_patches**.5)).unsqueeze(0)
